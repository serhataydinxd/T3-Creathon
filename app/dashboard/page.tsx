  ...
  return (
    <AppShell user={user}>
      <section className="page role-dashboard">
        {params.welcome && <div className="success-notice" role="status"><CheckCircle2 /> Hesabınız oluşturuldu. Eğitimci çalışma alanınız hazır.</div>}
